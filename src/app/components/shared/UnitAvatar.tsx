// ================================================
// FILE: src/app/components/shared/UnitAvatar.tsx
// ================================================
...
export const UnitAvatar = memo(({
  ...
  return (
    <>
      <div
        className={`${fallbackClassName} ${!isOpaqueFallback ? 'opacity-20 select-none pointer-events-none' : ''}`}
      ...
      <img
        ...
        className={`${imageClassName} transition-opacity duration-300 ease-out ${imgLoaded ? 'opacity-100' : 'opacity-0'}`}
