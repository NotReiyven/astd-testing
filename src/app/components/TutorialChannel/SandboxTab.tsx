      ...
      {showCertificate && (
         <div className="fixed inset-0 z-[100000] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in p-4">
            <div className="bg-[#1E1F22] border border-[#2B2D31] p-8 md:p-12 relative max-w-3xl w-full shadow-2xl flex flex-col items-center text-center animate-slide-up rounded-sm overflow-hidden">
               ...
               <p className="text-[#949BA4] text-[12px] md:text-[14px] uppercase tracking-widest mb-8">ASTD Value List Academy</p>
               
               <p className="text-[#DBDEE1] text-[14px] md:text-[16px] italic mb-10 max-w-lg leading-relaxed">
               ...
               <div className="mt-8 pt-6 border-t border-[rgba(255,255,255,0.06)] w-full flex justify-between items-end relative">
