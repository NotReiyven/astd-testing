    ...
    <div className="fixed inset-0 z-[1000000] flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-fade-in select-none font-sans">
      <div className="bg-card border border-border rounded-xl p-6 max-w-md w-full shadow-2xl flex flex-col relative animate-slide-up">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-[15px] font-bold text-foreground tracking-tight">Leaving application</h3>
            <p className="text-[12px] text-muted-foreground font-mono">{domain}</p>
          </div>
        </div>

        <p className="text-[13px] text-muted-foreground leading-relaxed mb-4">
          You are being redirected to an external website. We are not responsible for the content, privacy policies, or security of external links.
        </p>
        ...
        <label className="flex items-center gap-2.5 cursor-pointer group mb-6 select-none">
          ...
          <span className="text-[12px] font-medium text-muted-foreground group-hover:text-foreground transition-colors">
            Don't ask me again for <strong className="text-foreground">{domain}</strong>
          </span>
        </label>
        ...
        <div className="flex items-center justify-end gap-2.5">
          ...
          <button 
            ...
            className="px-4 py-2 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground text-[12px] font-semibold transition-colors shadow-sm focus-visible:outline-none cursor-pointer flex items-center gap-1.5"
          >
            Continue to site
          </button>
        </div>
