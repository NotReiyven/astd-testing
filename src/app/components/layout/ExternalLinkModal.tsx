    ...
    >
      <div className="bg-card border border-border rounded-xl p-6 max-w-md w-full shadow-2xl flex flex-col relative animate-slide-up">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 id="external-link-title" className="text-[15px] font-bold text-foreground tracking-tight">Leaving application</h3>
            <p className="text-[12px] text-muted-foreground font-mono">{domain}</p>
          </div>
        </div>

        <p id="external-link-desc" className="text-[13px] text-muted-foreground leading-relaxed mb-4">
