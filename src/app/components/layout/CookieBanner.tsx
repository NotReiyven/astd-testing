      ...
      <div className="bg-popover border border-border p-4 md:p-5 rounded-[12px] shadow-[0_20px_40px_rgba(0,0,0,0.6)] pointer-events-auto w-full max-w-4xl flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
        <div className="flex items-start gap-4 flex-1 min-w-0">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-foreground text-[15px] font-bold tracking-tight">
              We value your privacy
            </h3>
            <p className="text-muted-foreground text-[12px] leading-relaxed">
              We use strictly necessary cookies to make our site work. We'd also
              like to set optional analytics cookies to help us improve it. We
              won't set optional cookies unless you enable them. For more
              detailed information, see our{" "}
              <button
                onClick={() =>
                  window.document.dispatchEvent(
                    new CustomEvent("navigate", { detail: "privacy-policy" })
                  )
                }
        ...
        <div className="flex items-center gap-3 w-full md:w-auto flex-shrink-0">
          ...
          <button
            onClick={handleDecline}
            className="hidden md:flex text-muted-foreground hover:text-foreground p-1 ml-1 transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
