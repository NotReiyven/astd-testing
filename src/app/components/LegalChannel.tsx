        ...
        {isTos ? (
          <div className="flex flex-col gap-8 text-[14px] md:text-[15px] text-foreground leading-[1.8]">
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">1. Acceptance of Terms</h2>
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">2. Disclaimers & Non-Affiliation</h2>
              <p className="text-muted-foreground font-medium">
                ASTD Value List is a community-driven resource. We are <strong className="text-foreground">not affiliated, associated, authorized, endorsed by, or in any way officially connected with Roblox Corporation</strong>, the creators of All Star Tower Defense, or any of their subsidiaries or affiliates.
              </p>
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">3. Acceptable Use & API Rate Limiting</h2>
              <p className="text-muted-foreground font-medium">
              ...
              <ul className="list-disc pl-5 text-muted-foreground flex flex-col gap-2 mt-2 font-medium">
                <li>You agree not to use automated scripts, bots, or scrapers to continuously ping our API endpoints.</li>
                <li>We utilize strict Redis-based rate-limiting. Excessive requests will result in a temporary or permanent block of your IP address.</li>
                <li>Reverse engineering or attempting to exploit the backend architecture is strictly prohibited and will result in a permanent ban.</li>
              </ul>
            </section>

            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">4. Changes to Terms</h2>
              <p className="text-muted-foreground font-medium">
          ...
          <div className="flex flex-col gap-8 text-[14px] md:text-[15px] text-foreground leading-[1.8]">
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">1. Data We Do Not Collect</h2>
              <p className="text-muted-foreground font-medium">
                We believe in privacy by design. ASTD Value List operates primarily as a client-side application.
              </p>
              <ul className="list-disc pl-5 text-muted-foreground flex flex-col gap-2 mt-2 font-medium">
                <li>We <strong className="text-foreground">do not</strong> require account creation or login for core features (Calculator, Parsing, Search).</li>
                <li>We <strong className="text-foreground">do not</strong> ask for your Roblox password or any sensitive personal data (PII).</li>
                <li>Your active trade configurations, custom dictionary slang, and UI preferences are stored locally on your device using <code>localStorage</code> and IndexedDB.</li>
              </ul>
            </section>

            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">2. Analytics & Cookies</h2>
              <p className="text-muted-foreground font-medium">
              ...
              <ul className="list-disc pl-5 text-muted-foreground flex flex-col gap-2 mt-2 font-medium">
                ...
                <li>If you click "Accept All" on our cookie banner, Google Analytics places a cookie on your device to track page views and engagement time.</li>
                <li>If you decline, we only send anonymous, cookieless pings that do not track your session history.</li>
              </ul>
            </section>

            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">3. Server Logs & Rate Limiting</h2>
              <p className="text-muted-foreground font-medium">
                When you access our live data, your request passes through our serverless edge functions.
              </p>
              <ul className="list-disc pl-5 text-muted-foreground flex flex-col gap-2 mt-2 font-medium">
                <li>We utilize Redis to monitor request frequencies to prevent DDoS attacks and server abuse.</li>
                <li>Your IP address is temporarily processed in a sliding window memory solely for rate-limiting. It is not permanently stored or linked to a personal profile.</li>
              </ul>
            </section>

            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground tracking-tight">4. Third-Party Links</h2>
              <p className="text-muted-foreground font-medium">
