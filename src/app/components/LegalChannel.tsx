        ...
        {isTos ? (
          <div className="flex flex-col gap-8 text-[14px] md:text-[15px] text-foreground leading-[1.8]">
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">1. Acceptance of Terms</h2>
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">2. Disclaimers & Non-Affiliation</h2>
              <p className="text-muted-foreground">
              ...
              <ul className="list-disc pl-5 text-muted-foreground flex flex-col gap-2 mt-2">
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">3. Acceptable Use & API Rate Limiting</h2>
              <p className="text-muted-foreground">
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">4. Changes to Terms</h2>
              <p className="text-muted-foreground">
          ...
          <div className="flex flex-col gap-8 text-[14px] md:text-[15px] text-foreground leading-[1.8]">
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">1. Data We Do Not Collect</h2>
              <p className="text-muted-foreground">
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">2. Analytics & Cookies</h2>
              <p className="text-muted-foreground">
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">3. Server Logs & Rate Limiting</h2>
              <p className="text-muted-foreground">
            ...
            <section className="flex flex-col gap-3">
              <h2 className="text-[20px] font-bold text-foreground">4. Third-Party Links</h2>
              <p className="text-muted-foreground">
