...
// NEW: Centralized Status Icon component mapping neutral Lucide icons
export function StatusIcon({ status }: { status?: string | null }) {
  ...
  // Wrapped text-fallbacks to perfectly match SVG dimensions
          ...
          <div className="flex flex-col flex-1 px-3 md:px-4 pt-3 md:pt-4 pb-3 md:pb-4 relative z-10 bg-[#2B2D31] -mt-[1px]">
            <div className="flex flex-col">
              <div className="flex items-start gap-2">
                <h3 className="text-[13px] md:text-[15px] font-extrabold tracking-tight leading-snug flex-1 min-w-0 line-clamp-2 text-[#F2F3F5]">
                  <HighlightText text={unit.name} query={searchQuery} />
                </h3>
                {unit.notice && <div className="mt-0.5"><NoticeTooltip notice={unit.notice} /></div>}
              </div>
              <p className="text-[10px] md:text-[11px] font-bold uppercase tracking-wider leading-none mt-1 truncate text-[#949BA4]">
                <HighlightText text={unit.subtitle || ""} query={searchQuery} />
              </p>
              <div className="flex mt-1.5">
                {obtainability === "UNOB" ? (
                  <span className="text-[10px] font-bold uppercase text-[#949BA4] bg-[#1E1F22] px-1.5 py-0.5 rounded-[3px] border border-[rgba(255,255,255,0.05)] tracking-widest leading-none">UNOBTAINABLE</span>
                ) : (
                  <span className="text-[10px] font-bold uppercase text-[#DBDEE1] bg-[rgba(255,255,255,0.05)] px-1.5 py-0.5 rounded-[3px] border border-[rgba(255,255,255,0.1)] tracking-widest leading-none">OBTAINABLE</span>
                )}
              </div>
            </div>
