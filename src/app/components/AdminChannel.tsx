...
export function AdminChannel() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#1e2124] h-full select-none font-sans relative text-foreground">
      
      {/* Top Header */}
      <div className="flex-shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4 px-6 py-4 bg-[#282b30] border-b border-[#424549] shadow-sm z-20">
        ...
        <div className="flex items-center gap-3 overflow-x-auto hide-scrollbar">
          <div className="flex items-center gap-2 bg-[#1e2124] border border-[#424549] px-3.5 py-2 rounded-md shrink-0 shadow-inner">
      ...
      {/* Master Tabs */}
      {isMaster && (
        <div className="flex-shrink-0 bg-[#282b30] border-b border-[#424549] px-6 py-2.5 flex gap-2 shadow-sm z-10">
          <button 
            onClick={() => setAdminTab("users")}
            className={`flex items-center gap-2 px-4 py-2 rounded-md text-[12px] font-bold uppercase tracking-wider transition-all cursor-pointer focus-visible:outline-none ${adminTab === "users" ? "bg-[#7289da] text-white shadow-sm" : "bg-[#1e2124] text-muted-foreground hover:text-foreground border border-[#424549]"}`}
          >
            <UsersRound className="w-4 h-4" /> User Management
          </button>
          <button 
            onClick={() => setAdminTab("roles")}
            className={`flex items-center gap-2 px-4 py-2 rounded-md text-[12px] font-bold uppercase tracking-wider transition-all cursor-pointer focus-visible:outline-none ${adminTab === "roles" ? "bg-[#7289da] text-white shadow-sm" : "bg-[#1e2124] text-muted-foreground hover:text-foreground border border-[#424549]"}`}
          >
      ...
      {adminTab === "roles" && isMaster ? (
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-10 animate-fade-in bg-[#1e2124]">
          <div className="max-w-3xl mx-auto flex flex-col gap-6">
            ...
            <form onSubmit={handleCreateRole} className="bg-[#282b30] border border-[#424549] rounded-lg p-5 flex flex-col gap-4 shadow-md">
              <h3 className="text-[12px] font-bold text-foreground uppercase tracking-wider border-b border-[#424549] pb-2.5">Create New Role</h3>
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 flex flex-col gap-1.5">
                  ...
                  <input 
                    ...
                    className="bg-[#1e2124] border border-[#424549] rounded-md px-3.5 py-2.5 text-[13px] text-foreground focus:border-[#7289da] outline-none transition-colors w-full shadow-inner"
                    maxLength={20}
                    required
                  />
                </div>
                <div className="w-full sm:w-[130px] flex flex-col gap-1.5">
                  ...
                  <div className="flex items-center gap-2 bg-[#1e2124] border border-[#424549] rounded-md p-1.5 h-[42px] shadow-inner">
                    <input 
                      type="color" 
                      value={newRoleColor}
                ...
                <div className="w-full sm:w-[110px] flex flex-col gap-1.5">
                  ...
                  <input 
                    ...
                    min={3} max={98}
                    className="bg-[#1e2124] border border-[#424549] rounded-md px-3 py-2.5 text-[13px] text-foreground font-mono focus:border-[#7289da] outline-none transition-colors w-full h-[42px] shadow-inner"
                  />
                </div>
              </div>
            ...
            <div className="bg-[#282b30] border border-[#424549] rounded-lg flex flex-col overflow-hidden shadow-md">
              <div className="bg-[#1e2124] px-5 py-3.5 border-b border-[#424549]">
              ...
              <div className="flex flex-col p-3 gap-2">
                {availableRoles?.map(role => {
                  ...
                  return (
                    <div key={role.name} className="flex items-center justify-between p-3.5 bg-[#1e2124] border border-[#424549] rounded-md hover:border-[#7289da]/50 transition-all shadow-sm">
        ...
        <div className="flex-1 flex overflow-hidden animate-fade-in">
          ...
          {/* User List Sidebar */}
          <div className={`flex flex-col w-full ${selectedUser ? 'hidden md:flex md:w-[360px]' : 'flex'} shrink-0 border-r border-[#424549] bg-[#282b30] shadow-md z-10`}>
            <div className="p-3.5 border-b border-[#424549] bg-[#1e2124] flex flex-col gap-2.5">
              <form onSubmit={handleSearch} className="relative w-full">
                ...
                <input
                  ...
                  className="w-full bg-[#282b30] text-foreground text-[13px] pl-9 pr-3.5 py-2.5 rounded-md outline-none border border-[#424549] focus:border-[#7289da] transition-colors font-medium shadow-inner"
                />
              </form>
              <button 
                onClick={() => setShowBannedOnly(!showBannedOnly)}
                className={`w-full py-2 rounded-md text-[11px] font-bold uppercase tracking-wider transition-all border cursor-pointer ${showBannedOnly ? 'bg-destructive/20 text-destructive border-destructive/50 shadow-sm' : 'bg-[#282b30] text-muted-foreground border-[#424549] hover:bg-[#36393e] hover:text-foreground'}`}
              >
                  ...
                  {users.map(u => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-3 w-full p-3 rounded-md transition-all cursor-pointer focus-visible:outline-none text-left border ${isSelected ? 'bg-[#7289da]/20 text-white border-[#7289da]/60 shadow-sm' : 'hover:bg-[#36393e] text-muted-foreground border-transparent'} ${isBanned && !isSelected ? 'opacity-60' : ''}`}
                      >
                        <div className="relative shrink-0">
                          <img src={u.avatar_url || "/units/firezio.webp"} className="w-10 h-10 rounded-full bg-[#1e2124] object-cover border border-[#424549] shadow-inner" alt="" />
                          <div 
                            className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 rounded-full border-2 border-[#282b30] shadow-sm" 
          ...
          <div className={`flex-1 flex flex-col bg-[#1e2124] relative overflow-hidden ${!selectedUser ? 'hidden md:flex' : 'flex'}`}>
            {!selectedUser ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-6 bg-[#1e2124]">
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar animate-fade-in pb-12">
                ...
                <div className={`relative h-[130px] border-b border-[#424549] ${selectedUser.assigned_roles?.includes('banned') ? 'bg-destructive/20' : 'bg-[#282b30]'}`}>
                  <div className="absolute -bottom-10 left-6">
                    <img src={selectedUser.avatar_url || "/units/firezio.webp"} className="w-[96px] h-[96px] rounded-full object-cover border-[5px] border-[#1e2124] bg-[#282b30] shadow-md" alt="" />
                  </div>
                </div>
                ...
                <div className="mt-8 px-6 max-w-4xl mx-auto w-full flex flex-col xl:flex-row gap-6 items-start">
                  ...
                  <div className="flex flex-col gap-6 w-full xl:w-[320px] shrink-0">
                    <div className="bg-[#282b30] rounded-lg p-4.5 flex flex-col border border-[#424549] shadow-md">
                      ...
                      {userIntel.isLoading ? (
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="bg-[#1e2124] p-3 rounded-md border border-[#424549] shadow-inner">
                      ...
                      <div className="mt-4 pt-4 border-t border-[#424549] flex flex-col gap-2">
                        <button 
                          onClick={handleInspectProfile}
                          className="w-full flex items-center justify-between px-3.5 py-2.5 bg-[#1e2124] hover:bg-[#36393e] border border-[#424549] text-muted-foreground hover:text-foreground text-[12px] font-bold rounded-md transition-all cursor-pointer focus-visible:outline-none shadow-sm"
                        >
                    ...
                    <div className="bg-[#282b30] rounded-lg p-4.5 flex flex-col border border-[#424549] shadow-md gap-3">
                        ...
                        {availableRoles?.filter(role => role.name !== 'banned' && role.name !== 'master').map((r) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-md border text-[11px] font-bold uppercase tracking-wider transition-all cursor-pointer focus-visible:outline-none shadow-2xs ${disabled ? 'opacity-30 cursor-not-allowed' : 'hover:bg-[#1e2124]'}`}
                              style={{
                                backgroundColor: isAssigned ? `${r.color}20` : '#1e2124',
                                borderColor: isAssigned ? `${r.color}50` : '#424549',
                  ...
                  {selectedUser.id !== profile?.id && (
                    <div className="flex flex-col gap-6 w-full flex-1">
                      <div className="bg-[#282b30] rounded-lg p-5 border border-[#424549] shadow-md flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                          <div className="flex flex-col gap-2.5 bg-[#1e2124] p-3.5 rounded-md border border-[#424549]">
                            ...
                            <button 
                              ...
                              className="flex items-center gap-2.5 w-full p-2.5 bg-[#282b30] border border-[#424549] hover:border-destructive/60 text-muted-foreground hover:text-destructive rounded-md transition-all cursor-pointer focus-visible:outline-none shadow-sm"
                            >
                            ...
                            <button 
                              ...
                              className="flex items-center gap-2.5 w-full p-2.5 bg-[#282b30] border border-[#424549] hover:border-[#FAA61A]/60 text-muted-foreground hover:text-[#FAA61A] rounded-md transition-all cursor-pointer focus-visible:outline-none shadow-sm"
                            >
                      ...
                      <div className="bg-[#282b30] rounded-lg p-5 border border-[#424549] shadow-md flex flex-col gap-3">
                        ...
                        {modLogs.length === 0 ? (
                          <div className="text-[12px] text-muted-foreground italic p-4 bg-[#1e2124] rounded-md border border-[#424549]">
                          ...
                          <div className="flex flex-col gap-2.5 max-h-[320px] overflow-y-auto custom-scrollbar pr-1">
                            {modLogs.map(log => (
                              <div key={log.id} className="bg-[#1e2124] p-3.5 rounded-md border border-[#424549] flex flex-col gap-1.5 shadow-2xs animate-fade-in">
      ...
      {/* Confirmation Modal */}
      {modActionData && (
        <div className="fixed inset-0 z-[1000000] flex items-center justify-center p-4 bg-[#1e2124]/90 backdrop-blur-xs animate-fade-in">
          <div className="bg-[#282b30] border border-[#424549] rounded-lg p-6 max-w-md w-full shadow-2xl flex flex-col animate-slide-up">
            <h3 className="text-[16px] font-black text-foreground uppercase tracking-wide border-b border-[#424549] pb-3.5 mb-4 flex items-center gap-2.5">
            ...
            <textarea 
              ...
              className="bg-[#1e2124] text-foreground text-[13px] p-3.5 rounded-md border border-[#424549] focus:border-[#7289da] outline-none resize-none h-24 mb-5 shadow-inner"
              required
            />
            ...
            <div className="flex gap-3">
              <button 
                ...
                className="flex-1 py-2.5 rounded-md bg-[#1e2124] hover:bg-[#36393e] border border-[#424549] text-foreground text-[13px] font-bold transition-colors cursor-pointer focus-visible:outline-none shadow-sm"
              >
                Cancel
              </button>
              <button 
      ...
      {toast && (
        <div className="absolute bottom-6 right-6 z-[100000] animate-slide-up">
          <div className={`px-4.5 py-3 rounded-lg shadow-2xl flex items-center gap-3 border ${toast.type === 'error' ? 'bg-[#282b30] border-destructive/50 text-destructive' : 'bg-[#282b30] border-[#23a559]/50 text-[#23a559]'}`}>
