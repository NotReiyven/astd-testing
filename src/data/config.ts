...
export const MODAL_GIVE_SEED: TradeCard[] = [
  { id: "ultra-kovegu", name: "Ultra Kovegu", subtitle: "SSJ3 Gogeta", value: 20000, qty: 1 },
];
...
export const SEARCHABLE_UNITS: { id: string; name: string; subtitle: string; value: number }[] = [
